...
def get_data():
    ...
    IMPORTANT_DATES_TRAIN_DATA.extend(FACULTY_REPORT_TRAIN_DATA)
    IMPORTANT_DATES_TRAIN_DATA.extend(CURRICULUM_STUDY_TRAIN_DATA)
    IMPORTANT_DATES_TRAIN_DATA.extend(OPEN_RESIDENCE_HALLS_TRAIN_DATA)
    IMPORTANT_DATES_TRAIN_DATA.extend(HOLIDAYS_TRAIN_DATA)
    IMPORTANT_DATES_TRAIN_DATA.extend(ADD_DATE_TRAIN_DATA)
    IMPORTANT_DATES_TRAIN_DATA.extend(WITHDRAW_DATE_TRAIN_DATA)
    IMPORTANT_DATES_TRAIN_DATA.extend(DROP_DATE_TRAIN_DATA)
    IMPORTANT_DATES_TRAIN_DATA.extend(SEMESTER_START_TRAIN_DATA)
    IMPORTANT_DATES_TRAIN_DATA.extend(SEMESTER_END_TRAIN_DATA)
    IMPORTANT_DATES_TRAIN_DATA.extend(BREAK_TRAIN_DATA)
    IMPORTANT_DATES_TRAIN_DATA.extend(FINALS_TRAIN_DATA)
    IMPORTANT_DATES_TRAIN_DATA.extend(REGISTRATION_TRAIN_DATA)


    IMPORTANT_DATES_LABELS = []
    IMPORTANT_DATES_LABELS.append(FACULTY_REPORT_LABEL)
    IMPORTANT_DATES_LABELS.append(CURRICULUM_STUDY_LABEL)
    IMPORTANT_DATES_LABELS.append(OPEN_RESIDENCE_HALLS_LABEL)
    IMPORTANT_DATES_LABELS.append(HOLIDAYS_LABEL)
    IMPORTANT_DATES_LABELS.append(INSTRUCTION_BEGINS_LABEL)
    IMPORTANT_DATES_LABELS.append(ADD_DATE_LABEL)
    IMPORTANT_DATES_LABELS.append(WITHDRAW_DATE_LABEL)
    IMPORTANT_DATES_LABELS.append(DROP_DATE_LABEL)
    IMPORTANT_DATES_LABELS.append(SEMESTER_START_LABEL)
    IMPORTANT_DATES_LABELS.append(SEMESTER_END_LABEL)
    IMPORTANT_DATES_LABELS.append(BREAK_LABEL)
    IMPORTANT_DATES_LABELS.append(FINALS_LABEL)
    IMPORTANT_DATES_LABELS.append(REGISTRATION_LABEL)
    
    return IMPORTANT_DATES_TRAIN_DATA, IMPORTANT_DATES_LABELS
