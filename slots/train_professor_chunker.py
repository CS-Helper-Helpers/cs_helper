...
from slots.professor_data import get_data


def test_model(nlp):
    utterances = [
        "Does Dr. Steiner have office hours this Friday?",
        "Where is Cooper's office located?",
        "How can I reach Dr Tran?",
        "Can Dr Toups reserve a room for the gaming club?",
    ]
...
def chunk_professors(
    model=None, new_model_name="chunk_professor_model", output_dir=None, n_iter=30
):
